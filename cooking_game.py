...
while True:
    ...
    if not meat_achivement:
        if soup == 2:
            ...
            print(
                "You got Meat achievement, which means you can have meat in inventory, and you're able to make new "
                "Soup type!")
            meat_packages += 20
            print("")
            print("")
    ...
    if "make something" in command:
        ...
        if make_something == "soup":
            print(
                "In order to make Soup, you need self write in amounts of ingredients. If you don't remember you "
                "must check recipes!")
            ...
            if make_something == "soup with meat":
                print(
                    "In order to make Soup with Meatballs, you need self write in amounts of ingredients. If you "
                    "don't remember you must check recipes!")
                soup_water = int(input("Write deciliters of water you want to add: "))
                soup_potato = int(input("Write grams of potatoes you want to add: "))
                soup_carrot = int(input("Write amount of carrot(s) you want to add: "))
